...
jib {
	...
	container {
        labels = mapOf(
            ...
            "org.opencontainers.image.title" to "kconsumer",
            "org.opencontainers.image.description" to "An example Kafka consumer",
            "org.opencontainers.image.version" to "$version",
            "org.opencontainers.image.authors" to "$author",
            "org.opencontainers.image.url" to "https://github.com/thanhnamit/kconsumer",
